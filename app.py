...
# 🔥 CORREÇÕES DOS BOTÕES DE USUÁRIOS
...
def toggle_usuario(id):
    ...
    # NÃO deixa desativar o admin principal (id=1)
    if id == 1:
...
def delete_usuario(id):
    ...
    # NÃO deixa excluir admin principal
    if id == 1:
        return redirect(url_for("usuarios"))
